...
<head>
    ...
    <title>Community Hospital Lugoba| Online Application</title>
                ...
                <div class="row">
                    ...
                    <div id="menu" class="col-lg-9 col-md-9 d-none d-md-block nav-item">
                        <ul>
							...
							<a  href="Apply.php" class="dropdown-item">Apply Now</a>
							</li>
							</li>
                        </ul>
                    </div>
  ...
  <div class="page-nav no-margin row">
    ...
    <div class="container form-container">
      <div class=" col-lg-12 mx-auto login-container">
		  ...
		  <form action="insertapplication" method="POST" enctype="multipart/form-data">
          <div class="form-body">
            ...
            <div class="form-row row">
              ...
              <div class="col-lg-4 col-md-8">
                <input type="text" placeholder="Enter First Name" name="firstname" class="form-control form-control-sm" required>
              </div>
              <div class="col-lg-2 col-md-4">
              ...
              <div class="col-lg-4 col-md-8">
                <input type="text" placeholder="Enter Last Name" name="lastname" class="form-control form-control-sm">
              </div>
            </div>
            ...
            <div class="form-row row">
              ...
              <div class="col-lg-4 col-md-8">
                <input type="date" placeholder="Enter Date of Birth" name="dob" class="form-control form-control-sm" required>
              </div>
               <div class="col-lg-2 col-md-4">
            ...
            <div class="form-row row">
              ...
              <div class="col-lg-4 col-md-8">
                <input type="text" placeholder="Enter Father Name" name="fathername" class="form-control form-control-sm" required>
              </div>
                <div class="col-lg-2 col-md-4">
              ...
              <div class="col-lg-4 col-md-8">
                <input type="phone" placeholder="Enter Father Contact No" name="fathercontact" class="form-control form-control-sm" required>
              </div>
            </div>
             ...
             <div class="form-row row">
              ...
              <div class="col-lg-4 col-md-8">
                <input type="text" placeholder="Enter Mother Name" class="form-control form-control-sm" name="mothername">
              </div>
                <div class="col-lg-2 col-md-4">
              ...
              <div class="col-lg-4 col-md-8">
                <input type="text" placeholder="Enter Mother Contact No" class="form-control form-control-sm" name="mothercontact">
              </div>
            </div>
             ...
             <div class="form-row row">
              ...
              <div class="col-lg-4 col-md-8">
                <input type="tel" id="phone" name="phone"  placeholder="Format: 256 7xx xxxxxx" class="form-control form-control-sm" required>
              </div>
               <div class="col-lg-2 col-md-4">
               ...
               <div class="col-lg-4 col-md-8">
                <input type="email" placeholder="Enter Email Address" value="<?php echo $_SESSION['kacoshes']?>" readonly class="form-control form-control-sm" name="emailaddress" required>
              </div>
            </div>
            ...
            <div class="form-row row">
               ...
               <div class="col-lg-4 col-md-8">
                <input type="text" placeholder="Enter City" class="form-control form-control-sm" name="city">
              </div>
                <div class="col-lg-2 col-md-4">
              ...
              <div class="col-lg-4 col-md-8">
                <input type="text" placeholder="Enter Country" class="form-control form-control-sm" name="country">
              </div>
            </div>
             ...
             <div class="form-row row">
              ...
              <div class="col-lg-4 col-md-8">
                <textarea type="text" rows="5" name="fulladdress" placeholder="Enter Full Address" class="form-control form-control-sm"></textarea>
              </div> 
               <div class="col-lg-2 col-md-4">
              ...
              <div class="col-lg-4 col-md-8">
                <input type="text" placeholder="Enter Postal Code" name="postalcode" class="form-control form-control-sm">
              </div>
                <div class="col-lg-2 col-md-4"> 
              </div>
               <div class="col-lg-4 col-md-8">
              ...
              <div class="col-lg-4 col-md-8">
                 <select class="form-control form-control-sm" name="programss" required>
              ...
              <div class="col-lg-4 col-md-8">
			  <select class="form-control form-control-sm" name="intake" required>
			  ...
			  <option value="Jan 2013">Jan 2013</option>
			    ...
			    <div class="form-row row">
			   <div class="col-lg-2 col-md-4">
                <label for="">Educational Certificates Copies (In Pdf)</label>
              </div>
              <div class="col-lg-4 col-md-8">
                <input type="file" name="Filename" id="Filename" placeholder="Enter City" class="form-control form-control-sm">
              </div>
			  </div>
